      ...
      *>=================================================================================
       ...
       *>=================================================================================
       2100-incluir section.
            ...
            if   ws-operacao-ok
                 string "Código de bairro já utilizado! [" f-cd-bairro "]" into ws-mensagem
                 perform 9000-mensagem
            ...
            if   not ws-bairro-existente
                 ...
                 if   ws-mensagem-opcao-sim
                      ...
                      if   not ws-operacao-ok
                           string "Erro de gravação - f00500-bairro [" f00500-bairro "]" into ws-mensagem
                           perform 9000-mensagem
                      end-if
       ...
       *>=================================================================================
       2100-consulta section.
            ...
            perform 9000-ler-pd00500-ran-1
            if   not ws-operacao-ok
                 string "Código de bairro não encontrado! - [" f-cd-bairro "]" into ws-mensagem
                 perform 9000-mensagem
                 perform 8000-controle-frame 
            else
                 perform 9000-move-registros-frame
